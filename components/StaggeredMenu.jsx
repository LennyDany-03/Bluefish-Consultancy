...
/* Updated panel to be full viewport height and wider to match reference design */
.sm-scope .staggered-menu-panel { position: fixed; top: 0; right: 0; width: clamp(400px, 55vw, 800px); height: 100vh; background: white; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 4em 3em 4em; overflow-y: auto; z-index: 10; }
.sm-scope [data-position='left'] .staggered-menu-panel { right: auto; left: 0; }
/* Updated prelayers to match new panel width and be full viewport height */
.sm-scope .sm-prelayers { position: fixed; top: 0; right: 0; height: 100vh; width: clamp(400px, 55vw, 800px); pointer-events: none; z-index: 5; }
