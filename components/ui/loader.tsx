...
export const LoaderThree = () => {
  return (
    <motion.svg
      ...
      className="h-20 w-20 stroke-cyan-400 [--fill-final:#5227FF] [--fill-initial:rgb(34,211,238)] dark:stroke-cyan-400 dark:[--fill-final:#5227FF] dark:[--fill-initial:rgb(34,211,238)]"
    >
